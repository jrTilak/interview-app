...
export type ReadinessResponseDtoStatus = typeof ReadinessResponseDtoStatus[keyof typeof ReadinessResponseDtoStatus];


export const ReadinessResponseDtoStatus = {
  ok: 'ok',
} as const;
