...
import type { InterviewDetailsResponseDto } from './interviewDetailsResponseDto';

export type InterviewsControllerFindById200 = ApiSuccessResponseDto & {
  data?: InterviewDetailsResponseDto;
};
