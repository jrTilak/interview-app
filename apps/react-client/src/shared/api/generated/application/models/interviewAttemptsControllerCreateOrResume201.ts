...
import type { AttemptSnapshotResponseDto } from './attemptSnapshotResponseDto';

export type InterviewAttemptsControllerCreateOrResume201 = ApiSuccessResponseDto & {
  data: AttemptSnapshotResponseDto;
};
