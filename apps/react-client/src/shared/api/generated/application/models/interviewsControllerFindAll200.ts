...
import type { InterviewSummaryResponseDto } from './interviewSummaryResponseDto';

export type InterviewsControllerFindAll200 = ApiSuccessResponseDto & {
  data: InterviewSummaryResponseDto[];
};
