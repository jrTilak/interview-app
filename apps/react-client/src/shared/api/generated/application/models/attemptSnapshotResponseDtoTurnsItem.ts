 ...
 */
import type { AttemptSnapshotResponseDtoTurnsItemRole } from './attemptSnapshotResponseDtoTurnsItemRole';

export type AttemptSnapshotResponseDtoTurnsItem = {
  ...
  /**
     ...
     */
  sequence: number;
  role: AttemptSnapshotResponseDtoTurnsItemRole;
  text: string;
