...
export type AttemptSnapshotResponseDtoTurnsItemRole = typeof AttemptSnapshotResponseDtoTurnsItemRole[keyof typeof AttemptSnapshotResponseDtoTurnsItemRole];


export const AttemptSnapshotResponseDtoTurnsItemRole = {
  assistant: 'assistant',
  candidate: 'candidate',
} as const;
