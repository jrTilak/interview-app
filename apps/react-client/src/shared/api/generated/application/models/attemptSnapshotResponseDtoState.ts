...
export type AttemptSnapshotResponseDtoState = typeof AttemptSnapshotResponseDtoState[keyof typeof AttemptSnapshotResponseDtoState];


export const AttemptSnapshotResponseDtoState = {
  READY: 'READY',
