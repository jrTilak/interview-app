...
import type { DeletedInterviewResponseDto } from './deletedInterviewResponseDto';

export type InterviewsControllerRemove200 = ApiSuccessResponseDto & {
  data?: DeletedInterviewResponseDto;
};
