...
import type { SharedInterviewPreviewResponseDto } from './sharedInterviewPreviewResponseDto';

export type SharedInterviewsControllerPreview200 = ApiSuccessResponseDto & {
  data?: SharedInterviewPreviewResponseDto;
};
