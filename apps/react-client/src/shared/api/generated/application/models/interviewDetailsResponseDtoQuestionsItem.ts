...
export type InterviewDetailsResponseDtoQuestionsItem = {
  ...
  position: number;
  /**
     * Short question topic shown to the interviewer.
     * @minLength 3
     * @maxLength 160
     */
  title: string;
  /**
     * Question prompt used by the interviewer.
     * @minLength 1
     * @maxLength 2000
     */
  prompt: string;
  /**
     * What the question is intended to evaluate, when provided.
     * @minLength 1
     * @maxLength 2000
     * @nullable
     */
  ...
  /**
     * Optional guidance for asking a follow-up question.
     * @minLength 1
     * @maxLength 2000
     * @nullable
     */
