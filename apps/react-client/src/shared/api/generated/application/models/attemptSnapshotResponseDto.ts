 ...
 */
import type { AttemptSnapshotResponseDtoEndReason } from './attemptSnapshotResponseDtoEndReason';
import type { AttemptSnapshotResponseDtoMedia } from './attemptSnapshotResponseDtoMedia';
import type { AttemptSnapshotResponseDtoState } from './attemptSnapshotResponseDtoState';
import type { AttemptSnapshotResponseDtoTurnsItem } from './attemptSnapshotResponseDtoTurnsItem';

export interface AttemptSnapshotResponseDto {
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  id: string;
  state: AttemptSnapshotResponseDtoState;
  /**
     * @nullable
  ...
  endedAt: string | null;
  /** @nullable */
  endReason: AttemptSnapshotResponseDtoEndReason;
  media: AttemptSnapshotResponseDtoMedia;
  turns: AttemptSnapshotResponseDtoTurnsItem[];
}
