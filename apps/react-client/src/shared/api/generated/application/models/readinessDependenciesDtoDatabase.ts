...
export type ReadinessDependenciesDtoDatabase = typeof ReadinessDependenciesDtoDatabase[keyof typeof ReadinessDependenciesDtoDatabase];


export const ReadinessDependenciesDtoDatabase = {
  ok: 'ok',
} as const;
