...
export const healthControllerHealth = (
      ...
      return apiClient<HealthControllerHealth200>(
      {url: `/api`, method: 'GET'
    },
      );
    }
...
export const healthControllerReadiness = (
      ...
      return apiClient<HealthControllerReadiness200>(
      {url: `/api/ready`, method: 'GET'
    },
      );
    }
  export type HealthControllerHealthResult = NonNullable<Awaited<ReturnType<typeof healthControllerHealth>>>
export type HealthControllerReadinessResult = NonNullable<Awaited<ReturnType<typeof healthControllerReadiness>>>
