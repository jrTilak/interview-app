...
- `ai`: provider-neutral ports plus independent Gemini LLM, STT, and TTS adapters
...
- Raw microphone bytes go to the configured STT provider (Gemini in this phase); candidate email and future hidden tasks do not go to the model.
